...
open class CloudServicesControllerIntegrationTests {
    ...
    fun testTokenGeneration(){
        ...
        val testValue = restTemplate.getForEntity("$protocol://localhost:$port/auth/token", AuthenticationToken::class.java)
        assert(testValue.statusCode==HttpStatus.OK)
        ...
        val testValue2 = restTemplate.exchange("$protocol://localhost:$port/auth/token",HttpMethod.GET, httpEntity, AuthenticationToken::class.java)
        assert(testValue2.statusCode==HttpStatus.OK)
